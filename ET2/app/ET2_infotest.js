...
let alumnograduacion_def_tests = Array(
    // ADD
    Array('alumnograduacion','alumnograduacion_login','input',1,'Tamaño < 4','ADD','alumnograduacion_login_min_size_KO','El tamaño debe ser como min 4'),
    Array('alumnograduacion','alumnograduacion_login','input',2,'Tamaño > 15','ADD','alumnograduacion_login_max_size_KO','El tamaño debe ser de máximo 15'),
    Array('alumnograduacion','alumnograduacion_login','input',3,'No alfabetico','ADD','alumnograduacion_login_format_KO','Solo puede contener caracteres alfabéticos sin acentos ni ñ'),
    Array('alumnograduacion','alumnograduacion_login','input',4,'No acentuados','ADD','alumnograduacion_login_accented_KO','Solo puede contener caracteres alfabéticos sin acentos'),
    Array('alumnograduacion','alumnograduacion_login','input',5,'Válido','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_password','input',6,'Tamaño < 8','ADD','alumnograduacion_password_min_size_KO','El campo no puede tener una longitud menor a 8 caracteres'),
    Array('alumnograduacion','alumnograduacion_password','input',7,'Tamaño > 64','ADD','alumnograduacion_password_max_size_KO','El tamaño debe ser de máximo 64 caracteres'),
    Array('alumnograduacion','alumnograduacion_password','input',8,'No alfabéticos ni espacios en blanco','ADD','alumnograduacion_password_alpha_KO','Solo puede contener caracteres alfabéticos y espacios en blanco'),
    Array('alumnograduacion','alumnograduacion_password','input',9,'Tiene acentos','ADD','alumnograduacion_password_accented_KO','Solo puede contener caracteres alfabéticos sin acentos'),
    Array('alumnograduacion','alumnograduacion_password','input',10,'Válido','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_nombre','input',11,'Tamaño < 2','ADD','alumnograduacion_nombre_min_size_KO','El tamaño debe ser de mínimo 2'),
    Array('alumnograduacion','alumnograduacion_nombre','input',12,'Tamaño > 25','ADD','alumnograduacion_nombre_max_size_KO','El tamaño debe ser de máximo 25'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',13,'No alfabetico','ADD','alumnograduacion_apellidos_alpha_KO','Solo puede contener caracteres alfabéticos con acentos, ñ y espacios'),
    Array('alumnograduacion','alumnograduacion_nombre','input',14,'Válido','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_apellidos','input',15,'Tamaño < 2','ADD','alumnograduacion_apellidos_min_size_KO','El tamaño debe ser de mínimo 2'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',16,'Tamaño > 35','ADD','alumnograduacion_apellidos_max_size_KO','El tamaño debe ser de máximo 35'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',17,'No alfabetico','ADD','alumnograduacion_apellidos_alpha_KO','Solo puede contener caracteres alfabéticos con acentos, ñ y espacios'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',18,'Válido','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_titulacion','select',19,'Opción no válida','ADD','alumnograduacion_titulacion_valid_KO','Debe seleccionar una opción válida: GREI, GRIA, MEI, MIA, PCEO'),
    Array('alumnograduacion','alumnograduacion_titulacion','select',20,'Opción válida','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_dni','input',21,'Tamaño != 9','ADD','alumnograduacion_dni_min_size_KO','El tamaño debe ser 9'),
    Array('alumnograduacion','alumnograduacion_dni','input',22,'Solo numeros','ADD','alumnograduacion_dni_num_KO','Falta la letra'),
    Array('alumnograduacion','alumnograduacion_dni','input',23,'Letra invalida','ADD','alumnograduacion_dni_letter_KO','Formato nif o nie incorrecto, letra y número no se corresponden'),
    Array('alumnograduacion','alumnograduacion_dni','input',24,'Válido','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_telefono','input',25,'Tamaño != 9','ADD','alumnograduacion_telefono_min_size_KO','El tamaño debe ser de 9'),
    Array('alumnograduacion','alumnograduacion_telefono','input',26,'No dígitos','ADD','alumnograduacion_telefono_num_KO','Solo puede contener dígitos'),
    Array('alumnograduacion','alumnograduacion_telefono','input',27,'Válido','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_email','input',28,'Tamaño > 100','ADD','alumnograduacion_email_max_size_KO','El tamaño debe ser de máximo 100'),

    Array('alumnograduacion','alumnograduacion_direccion','textarea',29,'Tamaño < 0','ADD','alumnograduacion_direccion_min_size_KO','El campo no puede estar vacío'),
    Array('alumnograduacion','alumnograduacion_direccion','textarea',30,'No alfanumerico','ADD','alumnograduacion_direccion_alpha_KO','alfanuméricos con acentos y ñ y espacios'),
    Array('alumnograduacion','alumnograduacion_direccion','textarea',31,'Válido','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_email','input',32,'Correo vacío','ADD','alumnograduacion_email_empty_KO','El campo correo electrónico no puede estar vacío'),
    Array('alumnograduacion','alumnograduacion_email','input',33,'Tamaño < 5','ADD','alumnograduacion_email_min_size_KO','El tamaño debe ser de mínimo 5'),
    Array('alumnograduacion','alumnograduacion_email','input',34,'Tamaño > 100','ADD','alumnograduacion_email_max_size_KO','El tamaño debe ser de máximo 100'),
    Array('alumnograduacion','alumnograduacion_email','input',35,'Formato incorrecto','ADD','alumnograduacion_email_format_KO','El correo electrónico debe tener un formato válido'),
    Array('alumnograduacion','alumnograduacion_email','input',36,'Caracteres no permitidos','ADD','alumnograduacion_email_characters_KO','Solo puede contener caracteres alfabéticos, números, signos de puntuación y espacios en blanco'),
    Array('alumnograduacion','alumnograduacion_email','input',37,'Válido','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_login','input',38,'Login solo espacios','ADD','alumnograduacion_login_empty_KO','No puede contener solo espacios'),
    Array('alumnograduacion','alumnograduacion_login','input',39,'Login con espacios en medio','ADD','alumnograduacion_login_spaces_KO','No puede contener espacios'),
    Array('alumnograduacion','alumnograduacion_login','input',40,'Login con números','ADD','alumnograduacion_login_num_KO','Solo puede contener caracteres alfabéticos'),
    Array('alumnograduacion','alumnograduacion_login','input',41,'Login con símbolos','ADD','alumnograduacion_login_symbols_KO','Solo puede contener caracteres alfabéticos'),
    Array('alumnograduacion','alumnograduacion_login','input',42,'Login límite mínimo exacto','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_login','input',43,'Login límite máximo exacto','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_password','input',44,'Password solo espacios','ADD','alumnograduacion_password_empty_KO','No puede contener solo espacios'),
    Array('alumnograduacion','alumnograduacion_password','input',45,'Password con números','ADD','alumnograduacion_password_num_KO','Solo puede contener caracteres alfabéticos y espacios'),
    Array('alumnograduacion','alumnograduacion_password','input',46,'Password con símbolos','ADD','alumnograduacion_password_symbols_KO','Solo puede contener caracteres alfabéticos y espacios'),
    Array('alumnograduacion','alumnograduacion_password','input',47,'Password límite mínimo exacto','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_password','input',48,'Password límite máximo exacto','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_nombre','input',49,'Nombre solo espacios','ADD','alumnograduacion_nombre_empty_KO','No puede contener solo espacios'),
    Array('alumnograduacion','alumnograduacion_nombre','input',50,'Nombre con números','ADD','alumnograduacion_nombre_num_KO','Solo puede contener caracteres alfabéticos'),
    Array('alumnograduacion','alumnograduacion_nombre','input',51,'Nombre con símbolos','ADD','alumnograduacion_nombre_symbols_KO','Solo puede contener caracteres alfabéticos'),
    Array('alumnograduacion','alumnograduacion_nombre','input',52,'Nombre con ñ válido','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_nombre','input',53,'Nombre con acentos válido','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_nombre','input',54,'Nombre límite mínimo exacto','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_nombre','input',55,'Nombre límite máximo exacto','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_apellidos','input',56,'Apellidos solo espacios','ADD','alumnograduacion_apellidos_only_spaces_KO','No puede contener solo espacios'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',57,'Apellidos con números','ADD','alumnograduacion_apellidos_num_KO','Solo puede contener caracteres alfabéticos'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',58,'Apellidos con símbolos','ADD','alumnograduacion_apellidos_symbols_KO','Solo puede contener caracteres alfabéticos'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',59,'Apellidos múltiples válidos','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',60,'Apellidos con guión válido','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',61,'Apellidos límite mínimo exacto','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',62,'Apellidos límite máximo exacto','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_titulacion','select',63,'Titulación vacía','ADD','alumnograduacion_titulacion_empty_KO','Debe seleccionar una titulación'),
    Array('alumnograduacion','alumnograduacion_titulacion','select',64,'Titulación GRIA válida','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_titulacion','select',65,'Titulación MEI válida','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_titulacion','select',66,'Titulación MIA válida','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_titulacion','select',67,'Titulación PCEO válida','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_dni','input',68,'DNI con espacios','ADD','alumnograduacion_dni_spaces_KO','No puede contener espacios'),
    Array('alumnograduacion','alumnograduacion_dni','input',69,'DNI solo números','ADD','alumnograduacion_dni_numbers_KO','Debe incluir la letra'),
    Array('alumnograduacion','alumnograduacion_dni','input',70,'DNI letra minúscula válida','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_dni','input',71,'NIE válido formato X','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_dni','input',72,'NIE válido formato Y','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_dni','input',73,'NIE válido formato Z','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_telefono','input',74,'Teléfono con espacios','ADD','alumnograduacion_telefono_spaces_KO','No puede contener espacios'),
    Array('alumnograduacion','alumnograduacion_telefono','input',75,'Teléfono con guiones','ADD','alumnograduacion_telefono_dashes_KO','Solo puede contener dígitos'),
    Array('alumnograduacion','alumnograduacion_telefono','input',76,'Teléfono que empiece por 6','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_telefono','input',77,'Teléfono que empiece por 7','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_telefono','input',78,'Teléfono que empiece por 9','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_direccion','textarea',79,'Dirección solo espacios','ADD','alumnograduacion_direccion_only_spaces_KO','No puede contener solo espacios'),
    Array('alumnograduacion','alumnograduacion_direccion','textarea',80,'Dirección con números válida','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_direccion','textarea',81,'Dirección con comas válida','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_direccion','textarea',82,'Dirección límite máximo exacto','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_email','input',83,'Email sin @ inválido','ADD','alumnograduacion_email_no_at_KO','Debe contener @'),
    Array('alumnograduacion','alumnograduacion_email','input',84,'Email sin dominio inválido','ADD','alumnograduacion_email_no_domain_KO','Formato de dominio incorrecto'),
    Array('alumnograduacion','alumnograduacion_email','input',85,'Email múltiples @ inválido','ADD','alumnograduacion_email_multiple_at_KO','Solo puede contener un @'),
    Array('alumnograduacion','alumnograduacion_email','input',86,'Email con subdominios válido','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_email','input',87,'Email con números válido','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_email','input',88,'Email límite mínimo exacto','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_email','input',89,'Email límite máximo exacto','ADD',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_fotoacto','inputfile',90,'Foto vacía válida','ADD',true,'Campo opcional'),
    Array('alumnograduacion','alumnograduacion_fotoacto','inputfile',91,'Foto con extensión jpg válida','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_fotoacto','inputfile',92,'Foto con extensión png válida','ADD',true,'Éxito'),
    Array('alumnograduacion','alumnograduacion_fotoacto','inputfile',93,'Foto con espacios inválida','ADD','alumnograduacion_fotoacto_spaces_KO','No puede contener espacios'),
    Array('alumnograduacion','alumnograduacion_fotoacto','inputfile',94,'Foto sin extensión inválida','ADD','alumnograduacion_fotoacto_no_extension_KO','Debe incluir extensión válida'),

    // EDIT (se mantienen los mismos números que en ET1 para trazabilidad)
    Array('alumnograduacion','alumnograduacion_login','input',95,'Tamaño < 4','EDIT','alumnograduacion_login_too_short_KO','El tamaño debe ser como min 4'),
    Array('alumnograduacion','alumnograduacion_login','input',96,'Tamaño > 15','EDIT','alumnograduacion_login_too_long_KO','El tamaño debe ser de máximo 15'),
    Array('alumnograduacion','alumnograduacion_login','input',97,'No alfabetico','EDIT','alumnograduacion_login_not_alphabetic_KO','Solo puede contener caracteres alfabéticos sin acentos ni ñ'),
    Array('alumnograduacion','alumnograduacion_login','input',98,'Tiene acentos','EDIT','alumnograduacion_login_has_accents_KO','Solo puede contener caracteres alfabéticos sin acentos'),
    Array('alumnograduacion','alumnograduacion_login','input',99,'Válido','EDIT',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_password','input',100,'Tamaño < 8','EDIT','alumnograduacion_password_too_short_KO','El campo no puede tener una longitud menor a 8 caracteres'),
    Array('alumnograduacion','alumnograduacion_password','input',101,'Tamaño > 64','EDIT','alumnograduacion_password_too_long_KO','El tamaño debe ser de máximo 64 caracteres'),
    Array('alumnograduacion','alumnograduacion_password','input',102,'No alfabéticos ni espacios en blanco','EDIT','alumnograduacion_password_not_alphabetic_KO','Solo puede contener caracteres alfabéticos y espacios en blanco'),
    Array('alumnograduacion','alumnograduacion_password','input',103,'Tiene acentos','EDIT','alumnograduacion_password_has_accents_KO','Solo puede contener caracteres alfabéticos sin acentos'),
    Array('alumnograduacion','alumnograduacion_password','input',104,'Válido','EDIT',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_nombre','input',105,'Tamaño < 2','EDIT','alumnograduacion_nombre_too_short_KO','El tamaño debe ser de mínimo 2'),
    Array('alumnograduacion','alumnograduacion_nombre','input',106,'Tamaño > 25','EDIT','alumnograduacion_nombre_too_long_KO','El tamaño debe ser de máximo 25'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',107,'No alfabetico','EDIT','alumnograduacion_apellidos_not_alphabetic_KO','Solo puede contener caracteres alfabéticos con acentos, ñ y espacios'),
    Array('alumnograduacion','alumnograduacion_nombre','input',108,'Válido','EDIT',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_apellidos','input',109,'Tamaño < 2','EDIT','alumnograduacion_apellidos_too_short_KO','El tamaño debe ser de mínimo 2'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',110,'Tamaño > 35','EDIT','alumnograduacion_apellidos_too_long_KO','El tamaño debe ser de máximo 35'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',111,'No alfabetico','EDIT','alumnograduacion_apellidos_not_alphabetic_KO','Solo puede contener caracteres alfabéticos con acentos, ñ y espacios'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',112,'Válido','EDIT',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_titulacion','select',113,'Opción no válida','EDIT','alumnograduacion_titulacion_invalid_KO','Debe seleccionar una opción válida: GREI, GRIA, MEI, MIA, PCEO'),
    Array('alumnograduacion','alumnograduacion_titulacion','select',114,'Opción válida','EDIT',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_dni','input',115,'Tamaño != 9','EDIT','alumnograduacion_dni_invalid_length_KO','El tamaño debe ser 9'),
    Array('alumnograduacion','alumnograduacion_dni','input',116,'Solo numeros','EDIT','alumnograduacion_dni_not_numeric_KO','Falta la letra'),
    Array('alumnograduacion','alumnograduacion_dni','input',117,'Letra invalida','EDIT','alumnograduacion_dni_invalid_letter_KO','Formato nif o nie incorrecto, letra y número no se corresponden'),
    Array('alumnograduacion','alumnograduacion_dni','input',118,'Válido','EDIT',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_telefono','input',119,'Tamaño != 9','EDIT','alumnograduacion_telefono_invalid_length_KO','El tamaño debe ser de 9'),
    Array('alumnograduacion','alumnograduacion_telefono','input',120,'No dígitos','EDIT','alumnograduacion_telefono_not_numeric_KO','Solo puede contener dígitos'),
    Array('alumnograduacion','alumnograduacion_telefono','input',121,'Válido','EDIT',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_email','input',122,'Tamaño > 100','EDIT','alumnograduacion_email_too_long_KO','El tamaño debe ser de máximo 100'),

    Array('alumnograduacion','alumnograduacion_direccion','textarea',123,'Tamaño < 0','EDIT','alumnograduacion_direccion_too_short_KO','El campo no puede estar vacío'),
    Array('alumnograduacion','alumnograduacion_direccion','textarea',124,'No alfanumerico','EDIT','alumnograduacion_direccion_not_alphanumeric_KO','alfanuméricos con acentos y ñ y espacios'),
    Array('alumnograduacion','alumnograduacion_direccion','textarea',125,'Válido','EDIT',true,'Éxito'),

    Array('alumnograduacion','alumnograduacion_email','input',126,'Correo vacío','EDIT','alumnograduacion_email_empty_KO','El campo correo electrónico no puede estar vacío'),
    Array('alumnograduacion','alumnograduacion_email','input',127,'Tamaño < 5','EDIT','alumnograduacion_email_too_short_KO','El tamaño debe ser de mínimo 5'),
    Array('alumnograduacion','alumnograduacion_email','input',128,'Tamaño > 100','EDIT','alumnograduacion_email_too_long_KO','El tamaño debe ser de máximo 100'),
    Array('alumnograduacion','alumnograduacion_email','input',129,'Formato incorrecto','EDIT','alumnograduacion_email_invalid_format_KO','El correo electrónico debe tener un formato válido'),
    Array('alumnograduacion','alumnograduacion_email','input',130,'Caracteres no permitidos','EDIT','alumnograduacion_email_invalid_characters_KO','Solo puede contener caracteres alfabéticos, números, signos de puntuación y espacios en blanco'),
    Array('alumnograduacion','alumnograduacion_email','input',131,'Válido','EDIT',true,'Éxito'),

    // SEARCH
    Array('alumnograduacion','alumnograduacion_login','input',132,'Búsqueda vacía','SEARCH',true,'Se permite búsqueda vacía'),
    Array('alumnograduacion','alumnograduacion_login','input',133,'Búsqueda por login exacto','SEARCH',true,'Se encuentra el usuario por login exacto'),
    Array('alumnograduacion','alumnograduacion_login','input',134,'Búsqueda por login parcial','SEARCH',true,'Se encuentran usuarios por coincidencia parcial'),
    Array('alumnograduacion','alumnograduacion_login','input',135,'Búsqueda con caracteres no permitidos','SEARCH','alumnograduacion_login_format_KO','Solo puede contener caracteres alfabéticos sin acentos ni ñ'),

    Array('alumnograduacion','alumnograduacion_password','input',136,'Búsqueda vacía','SEARCH',true,'Se permite búsqueda vacía'),
    Array('alumnograduacion','alumnograduacion_password','input',137,'Búsqueda por password parcial','SEARCH',true,'Se encuentran usuarios por coincidencia parcial'),
    Array('alumnograduacion','alumnograduacion_password','input',138,'Búsqueda con caracteres no permitidos','SEARCH','alumnograduacion_password_invalid_characters_KO','Solo puede contener caracteres alfabéticos y espacios sin acentos ni ñ'),

    Array('alumnograduacion','alumnograduacion_nombre','input',139,'Búsqueda vacía','SEARCH',true,'Se permite búsqueda vacía'),
    Array('alumnograduacion','alumnograduacion_nombre','input',140,'Búsqueda por nombre parcial','SEARCH',true,'Se encuentran usuarios por coincidencia parcial'),
    Array('alumnograduacion','alumnograduacion_nombre','input',141,'Búsqueda con caracteres no permitidos','SEARCH','alumnograduacion_nombre_invalid_characters_KO','Solo puede contener caracteres alfabéticos con acentos, ñ y espacios'),

    Array('alumnograduacion','alumnograduacion_apellidos','input',142,'Búsqueda vacía','SEARCH',true,'Se permite búsqueda vacía'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',143,'Búsqueda por apellidos parcial','SEARCH',true,'Se encuentran usuarios por coincidencia parcial'),
    Array('alumnograduacion','alumnograduacion_apellidos','input',144,'Búsqueda con caracteres no permitidos','SEARCH','alumnograduacion_apellidos_invalid_characters_KO','Solo puede contener caracteres alfabéticos con acentos, ñ y espacios'),

    Array('alumnograduacion','alumnograduacion_titulacion','select',145,'Búsqueda vacía','SEARCH',true,'Se permite búsqueda vacía'),
    Array('alumnograduacion','alumnograduacion_titulacion','select',146,'Búsqueda por titulacion válida','SEARCH',true,'Se encuentra usuario por titulacion válida'),
    Array('alumnograduacion','alumnograduacion_titulacion','select',147,'Búsqueda por titulacion no válida','SEARCH','alumnograduacion_titulacion_format_KO','Debe seleccionar una opción válida: GREI, GRIA, MEI, MIA, PCEO'),

    Array('alumnograduacion','alumnograduacion_dni','input',148,'Búsqueda vacía','SEARCH',true,'Se permite búsqueda vacía'),
    Array('alumnograduacion','alumnograduacion_dni','input',149,'Búsqueda por DNI exacto','SEARCH',true,'Se encuentra el usuario por DNI exacto'),
    Array('alumnograduacion','alumnograduacion_dni','input',150,'Búsqueda por DNI parcial','SEARCH',true,'Se encuentran usuarios por coincidencia parcial'),
    Array('alumnograduacion','alumnograduacion_dni','input',151,'Búsqueda con formato incorrecto','SEARCH','alumnograduacion_dni_format_KO','Formato nif o nie incorrecto'),

    Array('alumnograduacion','alumnograduacion_telefono','input',152,'Búsqueda vacía','SEARCH',true,'Se permite búsqueda vacía'),
    Array('alumnograduacion','alumnograduacion_telefono','input',153,'Búsqueda por teléfono exacto','SEARCH',true,'Se encuentra el usuario por teléfono exacto'),
    Array('alumnograduacion','alumnograduacion_telefono','input',154,'Búsqueda por teléfono parcial','SEARCH',true,'Se encuentran usuarios por coincidencia parcial'),
    Array('alumnograduacion','alumnograduacion_telefono','input',155,'Búsqueda con caracteres no permitidos','SEARCH','alumnograduacion_telefono_invalid_characters_KO','Solo puede contener dígitos'),

    Array('alumnograduacion','alumnograduacion_direccion','textarea',156,'Búsqueda vacía','SEARCH',true,'Se permite búsqueda vacía'),
    Array('alumnograduacion','alumnograduacion_direccion','textarea',157,'Búsqueda por dirección parcial','SEARCH',true,'Se encuentran usuarios por coincidencia parcial'),
    Array('alumnograduacion','alumnograduacion_direccion','textarea',158,'Búsqueda con caracteres no permitidos','SEARCH','alumnograduacion_direccion_invalid_characters_KO','Solo puede contener caracteres alfanuméricos con acentos y ñ y espacios'),

    Array('alumnograduacion','alumnograduacion_email','input',159,'Búsqueda vacía','SEARCH',true,'Se permite búsqueda vacía'),
    Array('alumnograduacion','alumnograduacion_email','input',160,'Búsqueda por email exacto','SEARCH',true,'Se encuentra el usuario por email exacto'),
    Array('alumnograduacion','alumnograduacion_email','input',161,'Búsqueda por email parcial','SEARCH',true,'Se encuentran usuarios por coincidencia parcial'),
    Array('alumnograduacion','alumnograduacion_email','input',162,'Búsqueda con formato incorrecto','SEARCH','alumnograduacion_email_format_KO','El correo electrónico debe tener un formato válido'),

    Array('alumnograduacion','alumnograduacion_fotoacto','inputfile',163,'Búsqueda vacía','SEARCH',true,'Se permite búsqueda vacía'),
    Array('alumnograduacion','alumnograduacion_fotoacto','inputfile',164,'Búsqueda por nombre de foto exacto','SEARCH',true,'Se encuentra la foto por nombre exacto'),
    Array('alumnograduacion','alumnograduacion_fotoacto','inputfile',165,'Búsqueda por nombre de foto parcial','SEARCH',true,'Se encuentran fotos por coincidencia parcial'),
    Array('alumnograduacion','alumnograduacion_fotoacto','inputfile',166,'Búsqueda con caracteres no permitidos','SEARCH','alumnograduacion_fotoacto_invalid_characters_KO','Solo puede contener caracteres alfabéticos sin acentos ni ñ ni espacios y punto')
);

// Copia de los casos de prueba por campo (formato original) renombrados para ET2
let alumnograduacion_tests_fields_ET2 = Array(
    // ADD (copiados de ET1)
...
let articulo_def_tests = Array(
    ...
    Array('articulo','CodigoA','input',168,'Código no numérico','ADD','CodigoA_not_numeric_KO','El código debe ser numérico'),
    Array('articulo','AutoresA','input',169,'Autores demasiado largo','ADD','AutoresA_maxlen_KO','Máximo 200 caracteres'),
    Array('articulo','TituloA','input',170,'Título vacío','ADD','TituloA_empty_KO','El título no puede estar vacío'),
    Array('articulo','TituloR','input',171,'Título revista demasiado largo','ADD','TituloR_maxlen_KO','Máximo 100 caracteres'),
    Array('articulo','ISSN','input',172,'ISSN formato inválido','ADD','ISSN_format_KO','Formato ISSN inválido (ej. 1234-567X)'),
    Array('articulo','PagIniA','input',173,'Página inicio negativa','ADD','PagIniA_negative_KO','Debe ser entero >= 0'),
    Array('articulo','PagFinA','input',174,'Página fin menor que inicio','ADD','PagFinA_invalid_range_KO','PagFinA debe ser >= PagIniA'),
    Array('articulo','FechaPublicacionR','input',175,'Fecha inválida','ADD','FechaPublicacionR_format_KO','Formato fecha YYYY-MM-DD'),
    Array('articulo','FicheropdfA','inputfile',176,'PDF con extensión válida','ADD',true,'Éxito'),
    Array('articulo','FicheropdfA','inputfile',177,'PDF con extensión no permitida','ADD','FicheropdfA_type_KO','Solo se permiten ficheros .pdf'),
    Array('articulo','EstadoA','select',178,'Estado inválido','ADD','EstadoA_invalid_KO','Estado no permitido'),
    Array('articulo','EstadoA','select',179,'Estado válido','ADD',true,'Éxito'),
    // entradas adicionales extraídas de formatosPermitidos.txt
    Array('articulo','VolumenR','input',192,'Volumen demasiado largo','ADD','VolumenR_maxlen_KO','Máximo 4 caracteres'),
    ...
    Array('articulo','FicheropdfA','inputfile',194,'Fichero demasiado grande','ADD','FicheropdfA_size_KO','Tamaño máximo 5242880 bytes')
);

let articulo_tests_fields_ET2 = Array(
...
let ubicacion_def_tests = Array(
    ...
    Array('ubicacion','site_latitud','input',184,'latitud fuera de rango','ADD','site_latitud_range_KO','Latitud debe estar en [-90,90]'),
    Array('ubicacion','site_longitud','input',185,'longitud fuera de rango','ADD','site_longitud_range_KO','Longitud debe estar en [-180,180]'),
    Array('ubicacion','site_altitude','input',186,'altitud no numérica','ADD','site_altitude_not_numeric_KO','Altitud debe ser entero'),
    Array('ubicacion','site_locality','input',187,'localidad demasiado larga','ADD','site_locality_maxlen_KO','Máximo 40 caracteres'),
    Array('ubicacion','site_provider_login','input',188,'provider_login vacío','ADD','site_provider_login_empty_KO','No puede estar vacío'),
    Array('ubicacion','site_north_photo','inputfile',189,'foto norte con extensión válida','ADD',true,'Éxito'),
    Array('ubicacion','site_north_photo','inputfile',190,'foto norte tipo inválido','ADD','site_north_photo_type_KO','Solo jpg|jpeg|png permitidos'),
    Array('ubicacion','site_south_photo','inputfile',191,'foto sur con espacios inválidos','ADD','site_south_photo_name_KO','Nombre de archivo no puede contener espacios'),
    Array('ubicacion','site_east_photo','inputfile',199,'foto este con extensión válida','ADD',true,'Éxito'),
    Array('ubicacion','site_east_photo','inputfile',200,'foto este tipo inválido','ADD','site_east_photo_type_KO','Solo jpg|jpeg|png permitidos'),
    Array('ubicacion','site_east_photo','inputfile',201,'foto este nombre inválido (espacios)','ADD','site_east_photo_name_KO','Nombre de archivo no puede contener espacios'),
    Array('ubicacion','site_west_photo','inputfile',202,'foto oeste con extensión válida','ADD',true,'Éxito'),
    Array('ubicacion','site_west_photo','inputfile',203,'foto oeste tipo inválido','ADD','site_west_photo_type_KO','Solo jpg|jpeg|png permitidos'),
    Array('ubicacion','site_west_photo','inputfile',204,'foto oeste sin extensión','ADD','site_west_photo_no_extension_KO','Debe incluir extensión válida'),
    Array('ubicacion','site_latitud','input',205,'Latitud límite inferior válido','ADD',true,'Latitud -90 aceptada'),
    Array('ubicacion','site_latitud','input',206,'Latitud límite superior válido','ADD',true,'Latitud 90 aceptada'),
    Array('ubicacion','site_longitud','input',207,'Longitud límite inferior válido','ADD',true,'Longitud -180 aceptada'),
    Array('ubicacion','site_longitud','input',208,'Longitud límite superior válido','ADD',true,'Longitud 180 aceptada'),
    Array('ubicacion','site_provider_login','input',209,'Provider login demasiado largo','ADD','site_provider_login_maxlen_KO','Máximo 30 caracteres')
);

let ubicacion_tests_fields_ET2 = Array(
