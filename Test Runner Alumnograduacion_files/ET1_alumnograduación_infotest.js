...
let alumnograduacion_def_tests = Array(
    // ADD
    Array('alumnograduacion', 'alumnograduacion_login', 1, 'ADD', 'min_size', 'alumnograduacion_login_min_size_KO', 'El tamaño debe ser como min 4'),
    Array('alumnograduacion', 'alumnograduacion_login', 2, 'ADD', 'max_size', 'alumnograduacion_login_max_size_KO', 'El tamaño debe ser de máximo 15'),
    Array('alumnograduacion', 'alumnograduacion_login', 3, 'ADD', 'format', 'alumnograduacion_login_format_KO', 'Solo puede contener caracteres alfabéticos sin acentos ni ñ'),
    Array('alumnograduacion', 'alumnograduacion_login', 4, 'ADD', 'accented', 'alumnograduacion_login_accented_KO', 'Solo puede contener caracteres alfabéticos sin acentos'),
    Array('alumnograduacion', 'alumnograduacion_login', 5, 'ADD', 'valid', true, 'Éxito'),
    ...
    Array('alumnograduacion', 'alumnograduacion_apellidos', 13, 'ADD', 'No alfabetico', 'alumnograduacion_apellidos_alpha_KO', 'Solo puede contener caracteres alfabéticos con acentos, ñ y espacios'),
    ...
    Array('alumnograduacion', 'alumnograduacion_apellidos', 17, 'ADD', 'No alfabetico', 'alumnograduacion_apellidos_alpha_KO', 'Solo puede contener caracteres alfabéticos con acentos, ñ y espacios'),
    ...
    Array('alumnograduacion', 'alumnograduacion_titulacion', 19, 'ADD', 'Opción no válida', 'alumnograduacion_titulacion_valid_KO', 'Debe seleccionar una opción válida: GREI, GRIA, MEI, MIA, PCEO'),
    ...
    Array('alumnograduacion','alumnograduacion_telefono', 25, 'ADD', 'Tamaño != 9', 'alumnograduacion_telefono_min_size_KO', 'El tamaño debe ser de 9'),
    Array('alumnograduacion','alumnograduacion_telefono', 26, 'ADD', 'No dígitos', 'alumnograduacion_telefono_num_KO', 'Solo puede contener dígitos'),
    Array('alumnograduacion','alumnograduacion_telefono', 27, 'ADD', 'Tamaño = 9 y solo dígitos', true, 'Éxito'),

    Array('alumnograduacion','alumnograduacion_email', 28, 'ADD', 'Tamaño > 100', 'alumnograduacion_email_max_size_KO', 'El tamaño debe ser de máximo 100'),
    ...
    Array('alumnograduacion','alumnograduacion_email', 33, 'ADD', 'Tamaño < 5', 'alumnograduacion_email_min_size_KO', 'El tamaño debe ser de mínimo 5'),
    Array('alumnograduacion','alumnograduacion_email', 34, 'ADD', 'Tamaño > 100', 'alumnograduacion_email_max_size_KO', 'El tamaño debe ser de máximo 100'),
    Array('alumnograduacion','alumnograduacion_email', 35, 'ADD', 'Formato incorrecto; tiene que haber un @, seguido de caracteres alfanumericos un punto y algun caracter alfanumérico mas', 'alumnograduacion_email_format_KO', 'El correo electrónico debe tener un formato válido'),
    Array('alumnograduacion','alumnograduacion_email', 36, 'ADD', 'Caracteres no permitidos', 'alumnograduacion_email_characters_KO', 'Solo puede contener caracteres alfabéticos, números, signos de puntuación y espacios en blanco'),
    Array('alumnograduacion','alumnograduacion_email', 37, 'ADD', 'Tamaño entre 6 y 100 y formato correcto', true, 'Éxito'),
    Array('alumnograduacion', 'alumnograduacion_login', 38, 'ADD', 'Login solo espacios', 'alumnograduacion_login_empty_KO', 'No puede contener solo espacios'),
    Array('alumnograduacion', 'alumnograduacion_login', 39, 'ADD', 'Login con espacios en medio', 'alumnograduacion_login_spaces_KO', 'No puede contener espacios'),
    Array('alumnograduacion', 'alumnograduacion_login', 40, 'ADD', 'Login con números', 'alumnograduacion_login_num_KO', 'Solo puede contener caracteres alfabéticos'),
    Array('alumnograduacion', 'alumnograduacion_login', 41, 'ADD', 'Login con símbolos', 'alumnograduacion_login_symbols_KO', 'Solo puede contener caracteres alfabéticos'),
    ...
    Array('alumnograduacion', 'alumnograduacion_dni', 68, 'ADD', 'DNI con espacios', 'alumnograduacion_dni_spaces_KO', 'No puede contener espacios'),
    Array('alumnograduacion', 'alumnograduacion_dni', 69, 'ADD', 'DNI solo números', 'alumnograduacion_dni_numbers_KO', 'Debe incluir la letra'),
    ...
    Array('alumnograduacion', 'alumnograduacion_telefono', 75, 'ADD', 'Teléfono con guiones', 'alumnograduacion_telefono_dashes_KO', 'Solo puede contener dígitos'),
    ...
    Array('alumnograduacion', 'alumnograduacion_direccion', 79, 'ADD', 'Dirección solo espacios', 'alumnograduacion_direccion_only_spaces_KO', 'No puede contener solo espacios'),
    ...
    Array('alumnograduacion', 'alumnograduacion_nombre', 105, 'EDIT', 'Tamaño < 2', 'alumnograduacion_nombre_too_short_KO', 'El tamaño debe ser de mínimo 2'),
    Array('alumnograduacion', 'alumnograduacion_nombre', 106, 'EDIT', 'Tamaño > 25', 'alumnograduacion_nombre_too_long_KO', 'El tamaño debe ser de máximo 25'),
    Array('alumnograduacion', 'alumnograduacion_apellidos', 107, 'EDIT', 'No alfabetico', 'alumnograduacion_apellidos_not_alphabetic_KO', 'Solo puede contener caracteres alfabéticos con acentos, ñ y espacios'),
    ...
    Array('alumnograduacion', 'alumnograduacion_apellidos', 109, 'EDIT', 'Tamaño < 2', 'alumnograduacion_apellidos_too_short_KO', 'El tamaño debe ser de mínimo 2'),
    Array('alumnograduacion', 'alumnograduacion_apellidos', 110, 'EDIT', 'Tamaño > 35', 'alumnograduacion_apellidos_too_long_KO', 'El tamaño debe ser de máximo 35'),
    Array('alumnograduacion', 'alumnograduacion_apellidos', 111, 'EDIT', 'No alfabetico', 'alumnograduacion_apellidos_not_alphabetic_KO', 'Solo puede contener caracteres alfabéticos con acentos, ñ y espacios'),
    ...
    Array('alumnograduacion', 'alumnograduacion_dni', 115, 'EDIT', 'Tamaño != 9', 'alumnograduacion_dni_invalid_length_KO', 'El tamaño debe ser 9'),
    Array('alumnograduacion', 'alumnograduacion_dni', 116, 'EDIT', 'Solo numeros', 'alumnograduacion_dni_not_numeric_KO', 'Falta la letra'),
    Array('alumnograduacion', 'alumnograduacion_dni', 117, 'EDIT', 'Letra invalida', 'alumnograduacion_dni_invalid_letter_KO', 'Formato nif o nie incorrecto, letra y número no se corresponden'),
    Array('alumnograduacion', 'alumnograduacion_dni', 118, 'EDIT', 'Longitud y formato adecuados', true, 'Éxito'),

    Array('alumnograduacion','alumnograduacion_telefono', 119, 'EDIT', 'Tamaño != 9', 'alumnograduacion_telefono_invalid_length_KO', 'El tamaño debe ser de 9'),
    Array('alumnograduacion','alumnograduacion_telefono', 120, 'EDIT', 'No dígitos', 'alumnograduacion_telefono_not_numeric_KO', 'Solo puede contener dígitos'),
    Array('alumnograduacion','alumnograduacion_telefono', 121, 'EDIT', 'Tamaño = 9 y solo dígitos', true, 'Éxito'),

    Array('alumnograduacion','alumnograduacion_email', 122, 'EDIT', 'Tamaño > 100', 'alumnograduacion_email_too_long_KO', 'El tamaño debe ser de máximo 100'),

    Array('alumnograduacion','alumnograduacion_direccion', 123, 'EDIT', 'Tamaño < 0', 'alumnograduacion_direccion_too_short_KO', 'El campo no puede estar vacío'),
    Array('alumnograduacion', 'alumnograduacion_direccion', 124, 'EDIT', 'No alfanumerico', 'alumnograduacion_direccion_not_alphanumeric_KO', 'alfanuméricos con acentos y ñ y espacios'),
    ...
    Array('alumnograduacion','alumnograduacion_email', 126, 'EDIT', 'Correo vacío', 'alumnograduacion_email_empty_KO', 'El campo correo electrónico no puede estar vacío'),
    Array('alumnograduacion','alumnograduacion_email', 127, 'EDIT', 'Tamaño < 5', 'alumnograduacion_email_too_short_KO', 'El tamaño debe ser de mínimo 5'),
    ...
    Array('alumnograduacion','alumnograduacion_email', 129, 'EDIT', 'Formato incorrecto; tiene que haber un @, seguido de caracteres alfanumericos un punto y algun caracter alfanumérico mas', 'alumnograduacion_email_invalid_format_KO', 'El correo electrónico debe tener un formato válido'),
    Array('alumnograduacion','alumnograduacion_email', 130, 'EDIT', 'Caracteres no permitidos', 'alumnograduacion_email_invalid_characters_KO', 'Solo puede contener caracteres alfabéticos, números, signos de puntuación y espacios en blanco'),
    ...
    Array('alumnograduacion', 'alumnograduacion_dni', 151, 'SEARCH', 'Búsqueda con formato incorrecto', 'alumnograduacion_dni_format_KO', 'Formato nif o nie incorrecto'),
    ...
    Array('alumnograduacion', 'alumnograduacion_telefono', 155, 'SEARCH', 'Búsqueda con caracteres no permitidos', 'alumnograduacion_telefono_invalid_characters_KO', 'Solo puede contener dígitos'),
    ...
    Array('alumnograduacion', 'alumnograduacion_direccion', 158, 'SEARCH', 'Búsqueda con caracteres no permitidos', 'alumnograduacion_direccion_invalid_characters_KO', 'Solo puede contener caracteres alfanuméricos con acentos y ñ y espacios'),
